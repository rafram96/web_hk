...
export const projects: Project[] = [
  ...
  { code: "175", slug: "175", title: "Actualización del Estudio de Factibilidad del Terminal Portuario de Pucallpa", entity: "Autoridad Portuaria Nacional", postor: "Consorcio Terminal Portuario Pucallpa", type: "Preinversión", sector: "Portuario", date: "01/03/2012", amount: "S/ 2,217,966.62", status: "Terminado" },
  ...
  { code: "205", slug: "205", title: "Expediente Técnico: Hospital Provincial de Acobamba – Huancavelica", entity: "Gobierno Regional de Huancavelica", postor: "Consorcio Salud Centro", type: "Expediente Técnico", sector: "Salud", date: "05/12/2017", amount: "S/ 2,110,961.33", status: "Terminado" },
