...
export const projects: Project[] = [
  ...
  { code: "119", slug: "119", title: "Supervisión de Obra: Comisaría PNP Sicuani – Canchis, Cusco", entity: "Ministerio del Interior", type: "Supervisión", sector: "Seguridad", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-119.jpg` },
  { code: "120", slug: "120", title: "Expediente Técnico: Compañía de Bomberos N.º 49 de Cañete", entity: "Cuerpo General de Bomberos Voluntarios del Perú", type: "Expediente Técnico", sector: "Seguridad", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-120.jpg` },
  { code: "124", slug: "124", title: "Expediente Técnico: Jefatura de Identificación y Jefatura de Balanzas", entity: "Estado peruano", type: "Expediente Técnico", sector: "Administrativos", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-124.jpg` },
  { code: "133", slug: "133", title: "Mejoramiento de la Capacidad Resolutiva del Centro de Salud Pampas a Hospital", entity: "Gobierno Regional", type: "Expediente Técnico", sector: "Salud", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-133.jpg` },
  { code: "139", slug: "139", title: "Ampliación y Equipamiento de la Comisaría PNP Manchay – Pachacámac, Lima", entity: "Ministerio del Interior", type: "Expediente Técnico", sector: "Seguridad", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-139.jpg` },
  { code: "140", slug: "140", title: "Factibilidad: Ampliación y Remodelación del Establecimiento Penitenciario de Tacna", entity: "INPE", type: "Preinversión", sector: "Penitenciarios", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-140.jpg` },
  { code: "141", slug: "141", title: "Supervisión del Hospital Sicuani – Red Cusco", entity: "Gobierno Regional del Cusco", postor: "Consorcio CLAS Hidroenergía HK", type: "Supervisión", sector: "Salud", date: "05/09/2008", amount: "S/ 803,387.09", status: "Terminado", image: `${IMG}/proy-141.jpg` },
  { code: "142", slug: "142", title: "Expediente Técnico: Construcción del Establecimiento Penitenciario de Tarapoto", entity: "INPE", type: "Expediente Técnico", sector: "Penitenciarios", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-142.jpg` },
  { code: "143", slug: "143", title: "Supervisión: Nuevo Cuartel CBP Robespierre Colonna García N.º 31, Paita", entity: "Cuerpo General de Bomberos Voluntarios del Perú", type: "Supervisión", sector: "Seguridad", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-143.jpg` },
  { code: "145", slug: "145", title: "Evaluación del Estudio de Factibilidad: Mejoramiento de la Av. Néstor Gambetta, Callao", entity: "Gobierno Regional del Callao", type: "Preinversión", sector: "Vial", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-145.jpg` },
  { code: "148", slug: "148", title: "Expediente Técnico: Infraestructura de la Sede del Distrito Judicial de Amazonas", entity: "Poder Judicial", type: "Expediente Técnico", sector: "Administrativos", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-148.jpg` },
  { code: "149", slug: "149", title: "Diagnóstico para el Plan de Acondicionamiento Territorial y PDU de la Provincia de Arequipa", entity: "Municipalidad Provincial de Arequipa", type: "Planes territoriales", sector: "Urbanas", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-149.jpg` },
  { code: "150", slug: "150", title: "Perfil: Puentes Chamaya, Nueva Unida, Olaechea, Numpatken, Uchichiangos y Yahuahua, y accesos", entity: "Estado peruano", type: "Preinversión", sector: "Vial", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-150.jpg` },
  { code: "153", slug: "153", title: "Estudio Definitivo y Expediente Técnico: Centro de Servicios de SEDAPAL en Surquillo", entity: "SEDAPAL", type: "Expediente Técnico", sector: "Saneamiento", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-153.jpg` },
  { code: "159", slug: "159", title: "Expediente Técnico: Sede Principal del Ministerio Público – SJ Tacna (NCPP)", entity: "Ministerio Público", type: "Expediente Técnico", sector: "Administrativos", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-159.jpg` },
  { code: "161", slug: "161", title: "Expediente Técnico: Refacción y Acondicionamiento del Puesto de Control Tomasiri, Tacna", entity: "Estado peruano", type: "Expediente Técnico", sector: "Seguridad", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-161.jpg` },
  { code: "162", slug: "162", title: "Expediente Técnico: Sede de la Oficina Zonal de Cajamarca", entity: "Estado peruano", type: "Expediente Técnico", sector: "Administrativos", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-162.jpg` },
  { code: "166", slug: "166", title: "Supervisión: Seguridad Peatonal COSAC I – Protransporte", entity: "Protransporte – Municipalidad de Lima", type: "Supervisión", sector: "Vial", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-166.jpg` },
  ...
  { code: "206", slug: "206", title: "Factibilidad y Expediente: Servicios Recreativos en la U.P.I.S.–P.E.C.P., Ventanilla – Callao", entity: "Municipalidad de Ventanilla", type: "Preinversión y Expediente", sector: "Públicos", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-206.jpg` },
  ...
  { code: "218", slug: "218", title: "PAT, PDM y PDU: Tumbes, Lambayeque, La Libertad, Áncash, Lima e Ica (Ítem 2)", entity: "Ministerio de Vivienda, Construcción y Saneamiento", type: "Planes territoriales", sector: "Urbanas", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-218.jpg` },
  ...
  { code: "276", slug: "276", title: "Expediente Técnico: Servicios Culturales del Patrimonio Histórico – DDC Cusco", entity: "Ministerio de Cultura", type: "Expediente Técnico", sector: "Públicos", date: "—", amount: "—", status: "Terminado", image: `${IMG}/proy-276.jpg` },
  {
